package org.generation.blogpessoalgen.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.generation.blogpessoalgen.controller"))
	...
	private static Contact contact() {
		return new Contact("Renan Gonçalves Vanni", "https://github.com/renanvanni", "renanvanni13@gmail.com");
	}
